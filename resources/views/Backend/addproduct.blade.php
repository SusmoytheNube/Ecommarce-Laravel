...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="{{Route('Backend.addProduct')}}" method="POST" class="shadow p-5">
                ...
                <div class="form-group mb-3">
                  ...
                  <textarea type="text" name="pro_des" id="pro_des" cols="30" rows="2" class="form-control" placeholder="Enter Product Description"></textarea>
                </div>
                <div class="form-group mb-3">
                  <label for="pro_qty" class="form-label">Product Quantity</label>
                  <input type="number" name="pro_qty" id="pro_qty" class="form-control" placeholder="Enter Product Quantity">
                </div>
                <div class="form-group mb-3">
                  <label for="pro_price" class="form-label">Product Price</label>
                  <input type="number" name="pro_price" id="pro_price" class="form-control" placeholder="Enter Product Price">
                </div>
                <div class="form-group mb-3">
